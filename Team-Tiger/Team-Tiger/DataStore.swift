...
class DataStore {
    ...
    //var coordinatesFromDetailVC = detailViewController()
...
//    func getGoogleDetailsForCloseLocation(funcCoordinates: CLLocation, completionHandler: ([String:String]?) -> ()) {
//        
//    //func getGoogleDetailsForCloseLocation() {
//    
//        var latitudeAsString = String(funcCoordinates.coordinate.latitude)
//        let longitudeAsString = String(funcCoordinates.coordinate.longitude)
//        let locationAsString = "\(latitudeAsString), \(longitudeAsString)"
//        // 1. Parses coordinates from coord string
//        guard let coordinates = parseCoordinates(locationAsString) else {
//            completionHandler(nil)
//            return
//        }
//        
//        
//        // 2. Gets place id for location
...
//        
//        Alamofire.request(.GET, "https://maps.googleapis.com/maps/api/place/nearbysearch/json?location=\(latitude),\(longitude)&radius=500&type=restaurant&name=cruise&key=AIzaSyBkEKRXCtoXZThYqylgUrHKGkjAmJ_1mSM").responseJSON {response in
//            
//            guard let jsonData = response.data else {return}
//            let jsonObject = JSON(data: jsonData)
//            
//            guard let placeID = jsonObject["results"][1]["place_id"].string else {return}
//            
//            
...
//            
//           // self.mapURL = jsonObject["result"]["url"].stringValue
//
//            
//            
//        }
