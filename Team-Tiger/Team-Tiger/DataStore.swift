...
// FUNCTIONS FOR FARMERS MARKET + BOTANICAL GARDENS + COMMUNITY GARDEN PARSED DATA
            ...
            if let jsonData = response.data {
                ...
                if let arrayOfData = arrayOfData {
                    ...
                    for detail in arrayOfData {
                        ...
                        farmersMarketArray.append(dictionaryWithInfo)
                    }
                    print(dictionaryWithInfo)
                }
        ...
        Alamofire.request(.GET, "https://data.cityofnewyork.us/api/views/69ih-b9ki/rows.json?accessType=DOWNLOAD") .responseJSON {
            ...
            if let JSONdata = response.data {
                ...
                for object in arrayofData! {
                    ...
                    botanicalGardenArray.append(botanicalGardenDictionary)
                    
                }
            }
            print("\n\n\n\nTHIS IS OUTSIDE THE LOOP \(botanicalGardenArray)")
        }
    }
    
    func greenThumbParse() {
            ...
            if let jsonData = response.data {
                ...
                if let arrayOfData = arrayOfData {
                    ...
                    for detail in arrayOfData {
                        ...
                        greenThumbArray.append(dictionaryWithInfo)
                    }
                    
                    print("THIS IS OUTSIDE LOOP \(dictionaryWithInfo)")
                }
